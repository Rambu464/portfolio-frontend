...
export const heroData: HeroData = {
  ...
  tagline:
    "Being a developer is my hobby as well as passion. I'm certainly able to build website and AI model such as ML, DL, And LLM.",
...
export const projectsData: Project[] = [
  ...
  },
  {
    id: "project-2",
    title: "Skill Advisor",
    description: "Chatbot dengan API Gemini flash lite 2.5.",
